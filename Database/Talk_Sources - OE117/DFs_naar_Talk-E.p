...
/* 
   ...
   2021-05-06 :  aanpassing voor de database Talk
   2021-05-26 :  deze versie is voor de Emergency pipeline,  F:\E_Database
   
*/

define variable cReleaseDir                     as character   no-undo      initial 'F:\E_DataBase\DB-Schema\'.
...
DEFINE VARIABLE cInput_Names                    AS CHARACTER   NO-UNDO      initial "Talk_OE117\Corp_Db_Names.csv".
...
procedure Proc_Read_InputFile.
    ...
    repeat :
        ...
        if index(In_Lijn,"BUILD") ne 0
        OR index(In_Lijn,"EMERG") ne 0
        THEN DO:
    ...
    for each TT_Input
        ...
        then do:
             ...
             then do:
                  ...
                  IF cCorp EQ "BUILD"
                  OR cCorp EQ "EMERG"
                  THEN connect value(TT_Input.Db_Location) -1.
                  ELSE connect value(TT_Input.Db_Location) -1 -U value(cUser) -P value(cPasw).
        ...
        assign cProgName = cReleaseDir + "Talk_OE117\DFFile_Load.p".  /* Schema load */
        ...
        then do:
             assign cProgName = cReleaseDir + "Talk_OE117\Disconnect.p".
             run value(cProgName) (input TT_Input.Db_LogicName).
             put stream strLog unformatted string(time,"hh:mm:ss") "  " skip
                                           string(time,"hh:mm:ss") "  " skip
                                           string(time,"hh:mm:ss") "  " skip.   
...
procedure Proc_Stop_Databases.
    ...
    put stream strBat_Stop unformatted "Set probin=E:\Progress\OpenEdge\117\bin"                 skip
                                       "call %probin%\proenv psc"                                skip
                                       " "                                                       skip (2)
                                       "set logfile=F:\E_Database\Db-Schema\Log_Db_Stop.txt"     skip
                                       " "                                                       skip (2)
    ...
    put stream strBat_Start unformatted "Set probin=E:\Progress\OpenEdge\117\bin"                  skip
                                        "call %probin%\proenv psc"                                 skip
                                        " "                                                        skip (2)
                                        "set logfile=F:\E_Database\Db-Schema\Log_Db_Start.txt"     skip
                                        " "                                                        skip (2)
    ...
    for each TT_Db :
        ...
        then do:
             ...
             then do:    
                  assign cDb_Disp_Name = replace (TT_Db_Names.Db_Disp_Name, "_T", "_M").
             ...
             if TT_Db_Names.Db_Name eq "talk" /* extra Talk_M */
             then do:    
                  assign cDb_Disp_Name = replace (TT_Db_Names.Db_Disp_Name, "_T", "_M").
...
procedure Proc_Db_Names.
    ...
    repeat:
        ...
        case cCorp:
            ...
            when "Ecorp" then assign TT_Db_Names.Db_name      = entry(1, in_Lijn, ";")
                                     TT_Db_Names.Db_Disp_Name = entry(3, in_Lijn, ";").
