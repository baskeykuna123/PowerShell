...
/* 
   ...
   2021-07-27 :  aanpassing voor Dcorp, die komt er ook bij
                 
   
*/

define variable cReleaseDir                     as character   no-undo      initial 'F:\DataBase\DB-Schema\'.
...
procedure Proc_Stop_Databases.
    ...
    put stream strBat_Stop unformatted "Set probin=E:\Progress\OpenEdge\117\bin"                 skip
                                       ...
                                       " "                                                       skip (2)
                                       "set logfile=F:\Database\Db-Schema\Log_Db_Stop.txt"       skip
                                       " "                                                       skip (2)
    ...
    put stream strBat_Start unformatted "Set probin=E:\Progress\OpenEdge\117\bin"                  skip
                                        "call %probin%\proenv psc"                                 skip
                                        " "                                                        skip (2)
                                        "set logfile=F:\Database\Db-Schema\Log_Db_Start.txt"       skip
                                        " "                                                        skip (2)
...
procedure Proc_Db_Names.
    ...
    repeat:
        ...
        case cCorp:
            /* DCORP = ICORP */
            when "Dcorp" then assign TT_Db_Names.Db_name      = entry(1, in_Lijn, ";")
