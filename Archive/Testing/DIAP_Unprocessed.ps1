...
$UnprocessedFileHTMLTemplate=[String]::Format("{0}DIAPUnProcessedFile.html",$global:HTMLTemplateRoot)
$UnprocessedFileHtmTemplate=[String]::Format("{0}\DIAPUnProcessedFile.htm",$global:EnvironmentHTMLReportLocation)
...
Foreach($path in $($Locations.Value)){	
