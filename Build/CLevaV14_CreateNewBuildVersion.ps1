...
$DownloadFolder="\\balgroupit.com\appl_data\bbe\packages\$($ApplicationName)\Downloads\R$($Release)\"
...
if($CheckSFTP -ieq "true"){
	$MIDCsourcefolder='/in/ReleasesV14/R'+ $Release+'/'
	$MIDCarchive='/in/ReleasesV14/Archive/R'+$Release+'/'
	$Newdownload=DownloadSFTPFiles -Destination $tempdownload -source $MIDCsourcefolder -Type "MIDC" -Archive $MIDCarchive -PackagePath $PackagePath
		if(!$Newdownload){
