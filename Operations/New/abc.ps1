...
#Fetch Data 
#$Names=@("Baskey, Kuna","Turumella, Uday","Pai, Shivaji","Kumar Jha, Pankaj","Gorichela, Deepak","Adhikary, Bireshwar")
#foreach($name in $Names){
#$WIQL = "select * from WorkItems where [Work Item Type] = 'Defect' and [State] <> 'Closed' and [Assigned To] = '$($name)'"
select * from WorkItems WHERE [IterationPath] = 'Baloise\TO BE DELETED'
