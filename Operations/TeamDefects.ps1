...
#Fetch Data 
$Names=@("Kumar Jha, Pankaj", "Turumella, Uday", "Baskey, Kuna", "Gorichela, Deepak", "Rahate, Snehit", "Neha, Tiwari", "ICT Change Services, PROD")
...
$report+="<TR align=center><TD><B>$ID</B></TD><TD><B>$Title</B></TD><TD><B>$State</B></TD><TD><B>$name</B></TD></TR>"
