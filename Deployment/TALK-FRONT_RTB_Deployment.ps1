...
# 2019-12-26
# 
# RoundTable Front-Abstraction application
#
# get from release manifest the Version number Talk
# using a template (Template_RTB-Front_Jenkins_Menu.pf ( $Template_MenuFile ) )  to change input parameters needed voor RTB Deployment
#  ( -param "RelDir=RelFolder,RelNum=RelVersion" )
#
# pf-file used = RTB-Front_Jenkins_Menu.pf ( $Run_MenuFile )
#
# starting a command file ( E:\BuildScripts\RTB_Deploy\Start-Front.bat ) which executed an OE program ( Make_Release_Deploy.p )
# output and report are dropped in version folder ( \\balgroupit.com\appl_data\BBE\Packages\TALKFRONT\ )
#
# Pf-files, program, command file can be found in : E:\BuildScripts\RTB_Deploy (build server, SVW-BE-TLKBP001) 
#
# Release Report is inserted in Jenkins console output
#   
#----------------------------------------------------------------------------------------------------------------------
...
$TemplateFolder="\\balgroupit.com\appl_data\BBE\Transfer\Packages\Scripts\Templates\TalkFront\"
$PackagesFolder="\\balgroupit.com\appl_data\BBE\Packages\TALKFRONT"
...
$Template_MenuFile=join-path $TemplateFolder -ChildPath "Template_RTB-Front_Jenkins_Menu.pf"

$Run_MenuFile=join-path "E:\BuildScripts\RTB_Deploy\" -ChildPath "RTB-Front_Jenkins_Menu.pf"
...
$BatFile="E:\BuildScripts\RTB_Deploy\Start-Front.bat"
cmd.exe /C $Batfile
