...
# RTB releasefolder
$NewReleaseVersionFolder = [string]::Format("\\balgroupit.com\appl_data\BBE\Packages\TALK\R{0}\",$Release)
...
# Create Log File 
$LogFile = [String]::Format("{0}\logs\{1}_copy_deploy.txt",$WorkDirectory,$Version)
