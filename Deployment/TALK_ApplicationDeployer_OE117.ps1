...
# 2021-07-28 : Luc Mercken : added Version_Title, an update of the application Title (Icorp, Acorp) 
#
#                                                                               
Param($Environment)
...
$DbServer=[string]::Format("Life-{0}-Talk-App-BE.balgroupit.com",$Environment)

$TemplateFolder="\\balgroupit.com\appl_data\BBE\Transfer\Packages\Scripts\Templates\Talk\OE117\"
...
$Run_MenuFile=join-path "E:\Deploy\Version_Title\" -ChildPath "Version_Title.pf"
...
if ($Environment -ieq "ICORP" -or $Environment -ieq "ACORP") { 

    $BatFile="E:\Deploy\Version_Title\Version_Title.bat" 
