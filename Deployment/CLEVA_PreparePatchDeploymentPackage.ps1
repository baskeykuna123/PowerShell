Param($Environment,$ParameterImport,$PropertiesPrefix)
...
$PropertiesFilePath=[string]::Format("{0}{1}_ClevaDeploy.properties",$Global:JenkinsPropertiesRootPath,$PropertiesPrefix)
...
$EnvironmentProperties["ParamImportExport"]=$ParameterImport

#Setting Release Number based on Current Date and Environment
if($EnvironmentProperties["Environment"]-ne $Environment){
...
$EnvironmentProperties["Environment"]=$Environment
