Param([String]$Release,[String]$patchNumber,[string]$Assmeblies,[String]$ApplicationName,$tfsbranch)
...
$patchNumber="314392"
$Assmeblies=@"
Mercator.Esb.Service.Document.DocumentSet.Internal.Create.Messaging.dll#true#1.0
"@
$tfsbranch="Production/R26.0"
}
...
$patchinfo=Join-path $Global:JenkinsPropertiesRootPath -Childpath "ESBPatch.Properties"
