...
Remove-PSDrive U -Force -ErrorAction SilentlyContinue
...
$ClientsourceBasepath=join-path $Global:ClevaV14SourcePackages -ChildPath "$Release\$version\$clientsourcefolder"
...
New-PSdrive  -Name U -Root $ClientTemplatebasepath -PSProvider "Filesystem"  -Persist| Out-Null
$ClientTemplatebasepath="U:\"
#deployment location 
