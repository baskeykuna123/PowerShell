...
# 2021-05-12 : Luc Mercken : OE116 version !  others servers, citrix,  no DNS alias
#
#                                                                               
Param($Environment)
...
if($Environment -match "DCORP"){
	$BuildSourceFile="\\svw-be-tlkbp001.balgroupit.com\E$\GitSources\Scripts\Build_Scripts\Develop\Latest\build.pl"
}
else {
...
if($Environment -match "ECORP"){
	$BuildSourceFile="\\svw-be-tlkbp001.balgroupit.com\E$\Scripts\Build_Scripts\Ecorp\Latest\build.pl"
}
#>
